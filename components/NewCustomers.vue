<template>
    <section class="mt-5">
      ...
      <div
        class="mt-5 flex w-full  items-start gap-6 overflow-auto rounded-lg border bg-background px-5 py-5 scrollbar-thin scrollbar-thumb-input scrollbar-thumb-rounded-md"
      >
